<?php
/**
 * e-SPPO - Pusat Administrasi Pemilihan Terpadu (Pusminlihdu) - Pengawas, Daftar Kandidat
 * pusminlihdu/pengawas/daftar_kandidat.php
 * 
 * Halaman ini menampilkan daftar kandidat yang telah ditambahkan ke dalam sistem.
 * Pengawas dapat melihat informasi dasar kandidat seperti nomor urut, nama calon,
