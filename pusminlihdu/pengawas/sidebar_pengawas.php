...
$manajemenDataPemilihanPages = ['daftar_konstituensi', 'daftar_pemilih', 'daftar_kandidat'];
$konstituensiPages = ['daftar_konstituensi'];
$dptPages = ['daftar_pemilih'];
$kandidatPages = ['daftar_kandidat'];
$laporanPages = ['cetak_dpt', 'cetak_daftar_kandidat', 'cetak_laporan_pemilhan', 'cetak_kehadiran'];
  ...
  <div class="sidebar">
    ...
    <nav class="mt-2">
      <ul class="nav nav-pills nav-sidebar flex-column nav-child-indent" data-widget="treeview" role="menu" data-accordion="false">
        ...
        <li class="nav-header">LIHAT DATA PEMILIHAN</li>
