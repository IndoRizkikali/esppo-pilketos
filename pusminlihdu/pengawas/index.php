<?php
/**
 * e-SPPO - Pusat Administrasi Pemilihan Terpadu (Pusminlihdu) - Pengawas, Loader/Routing
 * pusminlihdu/pengawas/index.php
 *
 * File ini menangani pemuatan halaman untuk pengawas, termasuk inisialisasi sesi,
 * keamanan, dan pemetaan halaman. Pengawas hanya memiliki akses baca terhadap data
 * pemilihan dan tidak dapat melakukan perubahan.
 *
 * @version 2.0.0
...
// Cek apakah pengguna sudah login sebagai pengawas
// Jika tidak, arahkan ke halaman logout untuk keamanan.
if (!isset($_SESSION['admin_logged_in']) || $_SESSION['admin_logged_in'] !== true || $_SESSION['admin_role'] !== 'PENGAWAS') {
...
<div class="wrapper">
  ...
  <?php include_once 'sidebar_pengawas.php'; ?>
